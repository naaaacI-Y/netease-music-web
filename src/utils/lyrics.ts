import { LyricsResult } from "@/service/api/music/types";

export function lyricParser(lrc: LyricsResult) {
    return {
...
function parseLyric(lrc: string) {
     ...
     */
    const binarySearch = (lyric: { rawTime?: any; time: any; content?: string; }) => {
        let time = lyric.time;
